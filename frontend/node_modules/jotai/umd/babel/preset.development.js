(function (global, factory) {
  ...
  function isAtom(t, callee, customAtomNames) {
    ...
    if (t.isMemberExpression(callee)) {
      ...
      if (t.isIdentifier(property) && [].concat(atomFunctionNames, customAtomNames).includes(property.name)) {
        return true;
      }
    }
    return false;
    ...
    return {
      ...
      visitor: {
        ...
        VariableDeclarator: function VariableDeclarator(nodePath, state) {
          ...
          if (t.isIdentifier(nodePath.node.id) && t.isCallExpression(nodePath.node.init) && isAtom(t, nodePath.node.init.callee, options == null ? void 0 : options.customAtomNames) && (
          (_nodePath$parentPath$ = nodePath.parentPath.parentPath) != null && _nodePath$parentPath$.isProgram() || (_nodePath$parentPath$2 = nodePath.parentPath.parentPath) != null && _nodePath$parentPath$2.isExportNamedDeclaration())) {
            var filename = state.filename || 'unknown';
