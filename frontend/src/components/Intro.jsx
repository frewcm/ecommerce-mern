...
function Intro() {
  return (
    <div className="bg-center bg-cover bg-[url('/shop.jpg')] h-screen w-full">
      <div className="h-screen w-full bg-green-700 bg-opacity-40 flex items-center justify-center">
        <div className="flex flex-col justify-center items-center text-gray-50">
          ...
          <Link
            ...
            offset={50}
            duration={500}
            className=" w-28 p-2 border-2 border-green-900 bg-white text-green-900 duration-300 ease-in-out hover:bg-green-700 hover:text-white text-center rounded"
          >
            Shop
          </Link>
        </div>
